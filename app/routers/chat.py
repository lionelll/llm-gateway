...
async def _handle_non_stream(
    ...
    try:
        ...
        if status_code >= 400:
            ...
            # Provider failure health is already committed by the routing graph
            # (settle_balance commit includes the mark_provider_failure flush).
            # Do NOT re-mark here — that would double-increment consecutive_failures.
            session.add(
                create_request_log(
                    request_id=request_id,
                    user_id=user_id,
